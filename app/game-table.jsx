...
export default function GameTable() {
    ...
    useEffect(() => {
        const updateMusic = event => setMusicStatus(event.detail.status);
    ...
    function hooks() { return { update, sound: word => playSound(word, configRef.current), effect: animate, beforeEvent, wait: () => delay(120), ask: request }; }
